            ...
            <div class="col-md-4">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div><a href="{{route('company_planning_date',[$company->key])}}" class="btn btn-primary">View
                                planning</a></div>
                    </div>
                </div>
                        ...
                        <div class="overflow-500px">
                            <table class="table table-responsive table-striped">
                                    ...
                                    <th>
                                        @if($isAdmin)
                                            <a href="{{route('company_project_edit',['company_key'=>$company->key])}}"
                                               class="btn btn-success btn-xs">Add</a></th>
                                    @endif
                                </tr>
                                </thead>
                                <tbody>
                                ...
                                @foreach ($company->projects as $project)
                                    <tr>
                                        <td>
                                            <div style="background-color: {{$project->colorCategoryOrProject()}}">
                                                &nbsp;
                                            </div>
                                        </td>
                                        <td>
